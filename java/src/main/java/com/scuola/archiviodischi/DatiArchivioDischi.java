...
public class DatiArchivioDischi {

    public static ArchivioDischi getArchivio() {
        Autore autore;
        ...
        canzoni.add(new Canzone("Ne è valsa la pena", "rap"));
        canzoni.add(new Canzone("Non cambierò mai", "rap"));
